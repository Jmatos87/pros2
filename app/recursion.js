...
exports.recursionAnswers = {
  ...
  fibonacci: function(n) {
    ...
    for(var x=0;x<n;x++){
      var newValue = newFibArr.reduce(function(acc, val) {
      return acc + val;
      }, 0);

      newFibArr.push(newValue);
    ...
    console.log(n)
    console.log('new fib arr',newFibArr)
    console.log(newFibArr[n-1])

    // var fibArr = [0, 1, 1, 2, 3, 5, 8];



    return newFibArr[n-1]
